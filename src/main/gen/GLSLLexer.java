// Generated from D:/projects/java/ksml-compiler/src/main/antlr/GLSLLexer.g4 by ANTLR 4.13.2
...
public class GLSLLexer extends Lexer {
	...
	public static final int
		AT=1, IMPORT=2, ATOMIC_UINT=3, ATTRIBUTE=4, BOOL=5, BREAK=6, BUFFER=7, 
		BVEC2=8, BVEC3=9, BVEC4=10, CASE=11, CENTROID=12, COHERENT=13, CONST=14, 
		CONTINUE=15, DEFAULT=16, DISCARD=17, DMAT2=18, DMAT2X2=19, DMAT2X3=20, 
		DMAT2X4=21, DMAT3=22, DMAT3X2=23, DMAT3X3=24, DMAT3X4=25, DMAT4=26, DMAT4X2=27, 
		DMAT4X3=28, DMAT4X4=29, DO=30, DOUBLE=31, DVEC2=32, DVEC3=33, DVEC4=34, 
		ELSE=35, FALSE=36, FLAT=37, FLOAT=38, FOR=39, HIGHP=40, IF=41, IIMAGE1D=42, 
		IIMAGE1DARRAY=43, IIMAGE2D=44, IIMAGE2DARRAY=45, IIMAGE2DMS=46, IIMAGE2DMSARRAY=47, 
		IIMAGE2DRECT=48, IIMAGE3D=49, IIMAGEBUFFER=50, IIMAGECUBE=51, IIMAGECUBEARRAY=52, 
		IMAGE1D=53, IMAGE1DARRAY=54, IMAGE2D=55, IMAGE2DARRAY=56, IMAGE2DMS=57, 
		IMAGE2DMSARRAY=58, IMAGE2DRECT=59, IMAGE3D=60, IMAGEBUFFER=61, IMAGECUBE=62, 
		IMAGECUBEARRAY=63, IN=64, INOUT=65, INT=66, INVARIANT=67, ISAMPLER1D=68, 
		ISAMPLER1DARRAY=69, ISAMPLER2D=70, ISAMPLER2DARRAY=71, ISAMPLER2DMS=72, 
		ISAMPLER2DMSARRAY=73, ISAMPLER2DRECT=74, ISAMPLER3D=75, ISAMPLERBUFFER=76, 
		ISAMPLERCUBE=77, ISAMPLERCUBEARRAY=78, ISUBPASSINPUT=79, ISUBPASSINPUTMS=80, 
		ITEXTURE1D=81, ITEXTURE1DARRAY=82, ITEXTURE2D=83, ITEXTURE2DARRAY=84, 
		ITEXTURE2DMS=85, ITEXTURE2DMSARRAY=86, ITEXTURE2DRECT=87, ITEXTURE3D=88, 
		ITEXTUREBUFFER=89, ITEXTURECUBE=90, ITEXTURECUBEARRAY=91, IVEC2=92, IVEC3=93, 
		IVEC4=94, LAYOUT=95, LOWP=96, MAT2=97, MAT2X2=98, MAT2X3=99, MAT2X4=100, 
		MAT3=101, MAT3X2=102, MAT3X3=103, MAT3X4=104, MAT4=105, MAT4X2=106, MAT4X3=107, 
		MAT4X4=108, MEDIUMP=109, NOPERSPECTIVE=110, OUT=111, PATCH=112, PRECISE=113, 
		PRECISION=114, READONLY=115, RESTRICT=116, RETURN=117, SAMPLE=118, SAMPLER=119, 
		SAMPLER1D=120, SAMPLER1DARRAY=121, SAMPLER1DARRAYSHADOW=122, SAMPLER1DSHADOW=123, 
		SAMPLER2D=124, SAMPLER2DARRAY=125, SAMPLER2DARRAYSHADOW=126, SAMPLER2DMS=127, 
		SAMPLER2DMSARRAY=128, SAMPLER2DRECT=129, SAMPLER2DRECTSHADOW=130, SAMPLER2DSHADOW=131, 
		SAMPLER3D=132, SAMPLERBUFFER=133, SAMPLERCUBE=134, SAMPLERCUBEARRAY=135, 
		SAMPLERCUBEARRAYSHADOW=136, SAMPLERCUBESHADOW=137, SAMPLERSHADOW=138, 
		SHARED=139, SMOOTH=140, STRUCT=141, SUBPASSINPUT=142, SUBPASSINPUTMS=143, 
		SUBROUTINE=144, SWITCH=145, TEXTURE1D=146, TEXTURE1DARRAY=147, TEXTURE2D=148, 
		TEXTURE2DARRAY=149, TEXTURE2DMS=150, TEXTURE2DMSARRAY=151, TEXTURE2DRECT=152, 
		TEXTURE3D=153, TEXTUREBUFFER=154, TEXTURECUBE=155, TEXTURECUBEARRAY=156, 
		TRUE=157, UIMAGE1D=158, UIMAGE1DARRAY=159, UIMAGE2D=160, UIMAGE2DARRAY=161, 
		UIMAGE2DMS=162, UIMAGE2DMSARRAY=163, UIMAGE2DRECT=164, UIMAGE3D=165, UIMAGEBUFFER=166, 
		UIMAGECUBE=167, UIMAGECUBEARRAY=168, UINT=169, UNIFORM=170, USAMPLER1D=171, 
		USAMPLER1DARRAY=172, USAMPLER2D=173, USAMPLER2DARRAY=174, USAMPLER2DMS=175, 
		USAMPLER2DMSARRAY=176, USAMPLER2DRECT=177, USAMPLER3D=178, USAMPLERBUFFER=179, 
		USAMPLERCUBE=180, USAMPLERCUBEARRAY=181, USUBPASSINPUT=182, USUBPASSINPUTMS=183, 
		UTEXTURE1D=184, UTEXTURE1DARRAY=185, UTEXTURE2D=186, UTEXTURE2DARRAY=187, 
		UTEXTURE2DMS=188, UTEXTURE2DMSARRAY=189, UTEXTURE2DRECT=190, UTEXTURE3D=191, 
		UTEXTUREBUFFER=192, UTEXTURECUBE=193, UTEXTURECUBEARRAY=194, UVEC2=195, 
		UVEC3=196, UVEC4=197, VARYING=198, VEC2=199, VEC3=200, VEC4=201, VOID=202, 
		VOLATILE=203, WHILE=204, WRITEONLY=205, ADD_ASSIGN=206, AMPERSAND=207, 
		AND_ASSIGN=208, AND_OP=209, BANG=210, CARET=211, COLON=212, COMMA=213, 
		DASH=214, DEC_OP=215, DIV_ASSIGN=216, DOT=217, EQ_OP=218, EQUAL=219, GE_OP=220, 
		INC_OP=221, LE_OP=222, LEFT_ANGLE=223, LEFT_ASSIGN=224, LEFT_BRACE=225, 
		LEFT_BRACKET=226, LEFT_OP=227, LEFT_PAREN=228, MOD_ASSIGN=229, MUL_ASSIGN=230, 
		NE_OP=231, NUMBER_SIGN=232, OR_ASSIGN=233, OR_OP=234, PERCENT=235, PLUS=236, 
		QUESTION=237, RIGHT_ANGLE=238, RIGHT_ASSIGN=239, RIGHT_BRACE=240, RIGHT_BRACKET=241, 
		RIGHT_OP=242, RIGHT_PAREN=243, SEMICOLON=244, SLASH=245, STAR=246, SUB_ASSIGN=247, 
		TILDE=248, VERTICAL_BAR=249, XOR_ASSIGN=250, XOR_OP=251, DOUBLECONSTANT=252, 
		FLOATCONSTANT=253, INTCONSTANT=254, UINTCONSTANT=255, BLOCK_COMMENT=256, 
		LINE_COMMENT=257, LINE_CONTINUATION=258, IDENTIFIER=259, WHITE_SPACE=260, 
		DEFINE_DIRECTIVE=261, ELIF_DIRECTIVE=262, ELSE_DIRECTIVE=263, ENDIF_DIRECTIVE=264, 
		ERROR_DIRECTIVE=265, EXTENSION_DIRECTIVE=266, IF_DIRECTIVE=267, IFDEF_DIRECTIVE=268, 
		IFNDEF_DIRECTIVE=269, LINE_DIRECTIVE=270, PRAGMA_DIRECTIVE=271, UNDEF_DIRECTIVE=272, 
		VERSION_DIRECTIVE=273, MACRO_NAME=274, CONSTANT_EXPRESSION=275, ERROR_MESSAGE=276, 
		BEHAVIOR=277, EXTENSION_NAME=278, MACRO_IDENTIFIER=279, LINE_EXPRESSION=280, 
		MACRO_ESC_NEWLINE=281, MACRO_TEXT=282, DEBUG=283, OFF=284, ON=285, OPTIMIZE=286, 
		STDGL=287, PROGRAM_TEXT=288, NUMBER=289, PROFILE=290;
	public static final int
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"AT", "IMPORT", "ATOMIC_UINT", "ATTRIBUTE", "BOOL", "BREAK", "BUFFER", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'@'", "'import'", "'atomic_uint'", "'attribute'", "'bool'", "'break'", 
			"'buffer'", "'bvec2'", "'bvec3'", "'bvec4'", "'case'", "'centroid'", 
			"'coherent'", "'const'", "'continue'", "'default'", "'discard'", "'dmat2'", 
			"'dmat2x2'", "'dmat2x3'", "'dmat2x4'", "'dmat3'", "'dmat3x2'", "'dmat3x3'", 
			"'dmat3x4'", "'dmat4'", "'dmat4x2'", "'dmat4x3'", "'dmat4x4'", "'do'", 
			"'double'", "'dvec2'", "'dvec3'", "'dvec4'", null, "'false'", "'flat'", 
			"'float'", "'for'", "'highp'", null, "'iimage1D'", "'iimage1DArray'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "AT", "IMPORT", "ATOMIC_UINT", "ATTRIBUTE", "BOOL", "BREAK", "BUFFER", 
			"BVEC2", "BVEC3", "BVEC4", "CASE", "CENTROID", "COHERENT", "CONST", "CONTINUE", 
			"DEFAULT", "DISCARD", "DMAT2", "DMAT2X2", "DMAT2X3", "DMAT2X4", "DMAT3", 
			"DMAT3X2", "DMAT3X3", "DMAT3X4", "DMAT4", "DMAT4X2", "DMAT4X3", "DMAT4X4", 
			"DO", "DOUBLE", "DVEC2", "DVEC3", "DVEC4", "ELSE", "FALSE", "FLAT", "FLOAT", 
